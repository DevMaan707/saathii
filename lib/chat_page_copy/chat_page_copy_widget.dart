...
class _ChatPageCopyWidgetState extends State<ChatPageCopyWidget> {
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(text: 'Type a message...');
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF63B3A3),
        body: SafeArea(
          top: true,
          child: Padding(
              ...
              child: Stack(
                children: [
                      ...
                      Material(
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              Align(
                                alignment: AlignmentDirectional(-0.37, 0.1),
                                child: Padding(
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(8.0, 650.0, 8.0, 0.0),
                      child: TextFormField(
